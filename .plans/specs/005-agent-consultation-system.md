...
| AC-4 | Given the `.claude/agents/` directory, when listed, then it contains exactly 8 agent files: critic.md, skeptic.md, user-advocate.md, stakeholder.md, designer.md, project-manager.md, prompt-engineer.md, consistency-reviewer.md | REQ-F4 |
