...
| REQ-F4 | The initial agent roster shall include 7 agents across 4 categories: Evaluative (Critic, Skeptic), Perspective (User Advocate, Stakeholder), Structural (Designer, Project Manager), Meta (Prompt Engineer) | MUST | These perspectives cover the range needed for spec/design review; roster was designed during brainstorming and validated against framework needs |
...
| AC-4 | Given the agents/ directory, when listed, then it contains exactly 7 agent files: critic.md, skeptic.md, user-advocate.md, stakeholder.md, designer.md, project-manager.md, prompt-engineer.md | REQ-F4 |
...
- Agents modifying files — agents return analysis and recommendations; the main agent or user acts on them
