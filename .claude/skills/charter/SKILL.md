...
3. Check if CHARTER.md exists. If so, offer the user three options: (r)eview and update, (s)tart fresh, or (c)ancel.
...
Prompt for 3-5 core values that guide decisions. These should be specific and actionable, not generic platitudes. Collect one principle at a time until the user indicates they're done.
...
4. Set all three dates: "Charter established" = today, "Last reviewed" = today, "Next review" = derived from review schedule or left as placeholder.
